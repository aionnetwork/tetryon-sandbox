...
public class Groth16Proof implements Proof {
    private final ProvingScheme provingScheme = ProvingScheme.G16;

    private final G1Point a;
    private final G2Point b;
    private final G1Point c;

    public Groth16Proof(G1Point a, G2Point b, G1Point c) {
        this.a = a;
        this.b = b;
        this.c = c;
    }
    ...
    public static Groth16Proof deserialize(byte[] data) {
        ...
        return new Groth16Proof(a, b, c);
    }

    public static Groth16Proof parseJson(String proof) throws Exception {
